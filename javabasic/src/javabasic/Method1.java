...
public class Method1 {
	...
	public static void main(String[] args) {
		...
		// main에서 print메서드를 호출
		print("Hello Java!"); // 아래메서드에서 출력을 이미 적음, Method1. 이 생략된 것(static이어서)
		Method1.print("Hi Java");
		// main에서 add메서드를 호출
		System.out.println(add(10,20)); //add 앞에 Method1. 이 생략된것
	...
	static void print(String str) {
		...
		// return; : 리턴값이 없을 때는 return; 구문을 생략가능
		// 하지만, 생략하면 컴파일 과정에서 return구문을 넣어준다. 
		// 즉, 모든 메서드는 리턴구문을 가지고 있다.
	}
