...
public class RegularExpression {
	...
	public static void main(String[] args) {
		...
		String str4 = "abc123";
		String str5 = "ABC123";
		//영문자 3개가 나오고 숫자3개가 나오는 패턴
		System.out.println(str4.matches("[a-zA-z]{3}\\d{3}")); //true
		System.out.println(str5.matches("[a-zA-z]{3}\\d{3}")); //true
		...
		String patternStr1 = "^[0-9]{2,3}-[0-9]{3,4}-[0-9]{4}$";
		...
		//년도:00~99, 월:1~12, 일:01~31, 남녀구분:1~4중하나
		...
		String patternStr2 = "^\\d{2}(0[1-9]|1[0-2])(0[1-9]|1\\d|2\\d|3[0-1])-[1-4]\\d{6}$"; //맞추미~
		...
		//Pattern.MULTILINE : 문자열이 여러 라인으로 되어있을 때 여러 라인에서 패턴 매칭을 함
		
		//a가 0개이상나오고 b가 나오는 패턴 
		...
		System.out.println(m1.matches()); //t
		System.out.println(m2.matches()); //t 
		System.out.println(m3.matches()); //t
		System.out.println(m4.matches()); //f
		System.out.println(m5.matches()); //f
