 ...
 * StringBuffer, StringBuilding 클래스를 제공
 * StringBuffer : Thread Safe, 속도는 StringBuilder보다 느림
 * StringBuilding : Thread Unsafe, 속도는 StringBuffer보다 빠름
 */
...
public class StringBuilderTest {
	...
	public static void main(String[] args) {
		...
		System.out.println(sb1.capacity()); //용량 34, 문자수 20
