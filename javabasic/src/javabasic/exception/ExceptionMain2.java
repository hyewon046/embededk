...
public class ExceptionMain2 {
	...
	//2. 예외처리 위임 : 메소드 뒤에 throws 예외클래스명
	private static void c() throws ArithmeticException { //-> b 로 위임한 것임 -> b가 try catch적어서 처리하거나 a로 다시 위임하거나
