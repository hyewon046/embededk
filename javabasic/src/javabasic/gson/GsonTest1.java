...
public class GsonTest1 {
	...
	public static void main(String[] args) {
		...
		//pretty printing : JSON문자열을 들여쓰기해서 정렬해서 보여줌
...
//		System.out.println(jsonStr2);
		Person person2 = gson3.fromJson(jsonStr2, Person.class); //JSON문자열 -> Java 객체
		...
		//List객체를 Json문자열로 변환
		 ...
		 //Json문자열을 List객체로 변환
		 //TypeToken을 사용하여 List<Person>의 타입을 명시적으로 정의
