...
public class ComponentTest {
	...
	public static void main(String[] args) {
		//"Componenet"라는 타이틀을 가진 JFrame 생성
		...
		textPanel.add(new JTextField("텍스트필드")); //한줄
		textPanel.add(new JPasswordField("패스트월드")); //비밀번호처럼 글자가려져서
		textPanel.add(new JTextArea("텍스트에어리어")); //여러줄쓰기가능
		tabbedPane.addTab("텍스트패널", textPanel);
