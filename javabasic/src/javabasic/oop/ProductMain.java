...
public class ProductMain {
	...
	public static void main(String[] args) {
		...
		TV tv3 = (TV) tv2; //tv2는 Product타입, 가지고있는 참조는 TV
		
		//compile에러는 없음. 실행시에 런타임에러 ClassCastException
		//이유는? new Product()는 Product타입, 가지고있는 참조도 Product
		...
		System.out.println(((TV)tv4).company); //TV에 company가 있다는것은 아님, company를 가지고있는 Product에 접근이 가능하기때문
